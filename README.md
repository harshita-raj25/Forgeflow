...
```bash
.venv/bin/python -m pytest -q tests   # coordinator unit + orchestration tests (needs Docker); 71 tests (55 from the original build + 16 code-review regression tests)
```
